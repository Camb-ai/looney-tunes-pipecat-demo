...
function App() {
  ...
  return (
    <div className="min-h-screen bg-camb-bg flex flex-col items-center justify-center p-4">
      {/* Logo */}
      <div className="mb-8">
        <svg width="200" height="30" viewBox="0 0 655 100" fill="none" xmlns="http://www.w3.org/2000/svg">
